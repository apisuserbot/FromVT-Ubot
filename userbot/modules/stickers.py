...
KANGING_STR = [
    ...
    "Prosess Mengambil Sticker Ini Ke Pack Anda",
]
...
async def kang(args):
    ...
    if message and message.media:
        if isinstance(message.media, MessageMediaPhoto):
            ...
            return await args.edit("`File Ini Tidak Didukung!`")
    else:
    ...
    if photo:
                ...
                while "120" in x.text:
                    ...
                    if x.text == "Gagal Memilih Pack.":
                        ...
                        return await args.edit(
                            ...
                            f"\n[Klik Disini](t.me/addstickers/{packname}) Untuk Melihat Sticker Anda Sendiri",
                            parse_mode="md",
                        )
                if is_anim:
                    await conv.send_file("AnimatedSticker.tgs")
        ...
        await args.edit(
            f"**Berhasil Menambahkan Sticker Ke Pack Anda** **[Klik Disini](t.me/addstickers/{packname})** **Untuk Melihat Pack Anda**",
            parse_mode="md",
        )
